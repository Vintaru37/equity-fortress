...
<template>
  <form class="flex items-start gap-2" @submit.prevent="submit">
    ...
    <button
      type="submit"
      class="inline-flex h-10 min-h-10 items-center gap-2 self-start rounded-md bg-zinc-900 px-4 text-sm font-semibold text-white shadow-sm transition hover:bg-cyan-800 dark:bg-cyan-500 dark:text-zinc-950 dark:hover:bg-cyan-400"
    >
